...
1. This document.
2. The APK skeleton at [`android/`](../android/) — buildable Gradle
   project with stub modules for inference / journal / advice / export.
3. The mobile-responsive view of the existing chat UI (the same
...
4. The layer-2 schema (Room entities) is real; the encryption choices
