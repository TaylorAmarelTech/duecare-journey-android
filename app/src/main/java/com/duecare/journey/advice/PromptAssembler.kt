...
class PromptAssembler @Inject constructor(
    ...
    private fun personaForStage(stage: JourneyStage, corridor: String?): String {
        ...
        return "You are a 40-year migrant-worker safety expert " +
            ...
            "The worker is currently at the **${stage.name}** stage of " +
            "their migration$corridorNote. Tailor your guidance to " +
            "their stage. If you detect any of the 11 ILO Forced Labour " +
            "Indicators, name them. If you cite a statute, include the " +
            "section number. If the worker may have a complaint to file, " +
            "name the specific NGO/regulator they should contact and the " +
            "evidence they should retain. Do NOT optimize any structure " +
            "that contains trafficking indicators, regardless of the " +
            "worker's apparent consent — Palermo Art. 3(b) controls."
    }
}
